<?php
/**
 * Custom template tags for Webibazaar
 *
 * @package WordPress
...
function the_posts_pagination() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		<h3 class="screen-reader-text"><?php esc_html_e( 'Posts navigation', 'technivo' ); ?></h3>
...
function wntr_posted_on() {
	if ( is_sticky() && is_home() && ! is_paged() ) {
		echo '<span class="featured-post">' . esc_html__( 'Sticky', 'technivo' ) . '</span>';
	}
