   ...
   function  __construct(){
	...
	<ul class="toggle-block">
			...
			<?php if(!empty($linkURL1)) :  ?>
				<a href="<?php echo esc_url($linkURL1); ?>" title="<?php echo esc_attr_e('Facebook', 'technivo');?>" class="facebook icon"><i class="fa fa-facebook"></i></a>
			<?php endif; ?>
			<?php if(!empty($linkURL2)) :  ?>
				<a href="<?php echo esc_url($linkURL2); ?>" title="<?php echo esc_attr_e('Twitter', 'technivo');?>" class="twitter icon"><i class="fa"><svg width="16" height="14" class="icon icon-twitter" viewBox="0 0 16 14" xmlns="http://www.w3.org/2000/svg">
  <path d="M0.168061 0L5.94314 7.72183L0.131592 14H1.43954L6.52754 8.50337L10.6385 14H15.0895L8.98948 5.84383L14.3988 0H13.0909L8.40509 5.06229L4.61905 0H0.168061ZM2.09149 0.963435H4.13629L13.1658 13.0364H11.121L2.09149 0.963435Z" fill="currentcolor"></path>
</svg></i></a>
			<?php endif; ?>	
			<?php if(!empty($linkURL3)) :  ?>
				<a href="<?php echo esc_url($linkURL3); ?>" title="<?php echo esc_attr_e('Linkedin', 'technivo');?>" class="linkedin icon"><i class="fa fa-linkedin"></i></a>
			<?php endif; ?>
			<?php if(!empty($linkURL4)) :  ?>
				<a href="<?php echo esc_url($linkURL4); ?>" title="<?php echo esc_attr_e('RSS', 'technivo');?>" class="rss icon"><i class="fa fa-rss"></i></a>
			<?php endif; ?>
			<?php if(!empty($linkURL5)) :  ?>
				<a href="<?php echo esc_url($linkURL5); ?>" title="<?php echo esc_attr_e('Youtube', 'technivo');?>" class="youtube icon"><i class="fa fa-youtube"></i></a>
			<?php endif; ?>	
			<?php if(!empty($linkURL6)) :  ?>
				<a href="<?php echo esc_url($linkURL6); ?>" title="<?php echo esc_attr_e('Pinterest', 'technivo');?>" class="pinterest icon"><i class="fa fa-pinterest"></i></a>
			<?php endif; ?>
			<?php if(!empty($linkURL7)) :  ?>
				<a href="<?php echo esc_url($linkURL7); ?>" title="<?php echo esc_attr_e('Google Plus', 'technivo');?> " class="google-plus icon"><i class="fa fa-google-plus"></i></a>
			<?php endif; ?>
			<?php if(!empty($linkURL8)) :  ?>
				<a href="<?php echo esc_url($linkURL8); ?>" title="<?php echo esc_attr_e('Skype', 'technivo');?>" class="skype icon"><i class="fa fa-skype"></i></a>
			<?php endif; ?>
			<?php if(!empty($linkURL9)) :  ?>
				<a href="<?php echo esc_url($linkURL9); ?>" title="<?php echo esc_attr_e('Instagram', 'technivo');?>" class="instagram icon"><i class="fa fa-instagram"></i></a>
			<?php endif; ?>	
			<?php if(!empty($linkURL10)) :  ?>
				<a href="<?php echo esc_url($linkURL10); ?>" title="<?php echo esc_attr_e('Vimeo', 'technivo');?>" class="vimeo icon"><i class="fa fa-vimeo"></i></a>
			<?php endif; ?>	
			</li>
...
<p><label for="<?php echo esc_attr($this->get_field_id('title'));?>"><?php esc_html_e('Title:', 'technivo'); ?></label><input class="widefat" id="<?php echo esc_attr($this->get_field_id('title'));?>" name="<?php echo esc_attr($this->get_field_name('title'));?>" type="text" value="<?php echo esc_attr($title);?>" /></p>
<p>
