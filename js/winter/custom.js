...
jQuery(document).ready(function() {
    ...
    if (jQuery(window).width() <= 979) {
        jQuery(".main-navigation").prependTo(".header-left");  
        jQuery(".header-search").prependTo(".header-bottom .container .wbbottom"); 
        jQuery(".topbar-link").prependTo(".header-right"); 
        jQuery(".wishlist-menu").prependTo(".header-right"); 
    }
...
jQuery(document).ready(function($){
    ...
    var widget = $('#wpmegamenu_widget-2');
...
jQuery(document).ready(function($){
    ...
    var widget = $('.category-list');

    widget.on('mouseenter', function(){
        $('#wpmm-wrap-megamenu').addClass('wb-active');
    });

    widget.on('mouseleave', function(){
        $('#wpmm-wrap-megamenu').removeClass('wb-active');
    });
